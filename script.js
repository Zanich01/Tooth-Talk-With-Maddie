function toggleSearchBar() {
  ...
  async function fetchWorldPopulation() {
    try {
        ...
        displayPopulationData(totalPopulation);
    } catch (error) {
        console.error('Error fetching population data:', error);
        document.getElementById('result').innerHTML = `<p>Error fetching data: ${error.message}. Please try again later.</p>`;
    }
  }
  ...
  // Fetch world population data when the page loads
  window.onload = fetchWorldPopulation;